...
import charusat.vrund17.home.CardItem;
import charusat.vrund17.home.HomeRecyclerAdapter;
...
public class Home_Fragment extends Fragment {
    ...
    private void setArrayListItems() {
        ...
        cardItemArrayList.add(new CardItem(R.drawable.home_image_5, R.string.home_title_string));
        ...
        cardItemArrayList.add(new CardItem(R.drawable.home_image_1, R.string.home_about_four_string));
